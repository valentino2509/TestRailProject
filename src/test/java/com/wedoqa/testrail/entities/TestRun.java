...
public class TestRun extends BaseEntity {
    ...
    /**
     * @param caseID - specific caseID you want to access from current TestRun
     * @return specific TestInstance entity from the current TestRun
     */
    public TestInstance getTest(Integer caseID){
        for (TestInstance testInstance : getTests()){
            if(testInstance.getCaseId().equals(caseID)){
                return testInstance;
            }
        }
        return null;
	...
	public String toString() {
		return "TestRun [id=" + id + ", name=" + name + ", description=" + description + ", suiteId=" + suiteId
				+ ", milestoneId=" + milestoneId + ", config=" + config + ", isCompleted=" + isCompleted
				+ ", passedCount=" + passedCount + ", blockedCount=" + blockedCount + ", untestedCount=" + untestedCount
				+ ", retestCount=" + retestCount + ", failedCount=" + failedCount + ", createdBy=" + createdBy
				+ ", createdOn=" + createdOn + ", projectId=" + projectId + ", planId=" + planId + ", assignedtoId="
				+ assignedtoId + ", includeAll=" + includeAll + ", completedOn=" + completedOn + ", url=" + url
				+ ", configIds=" + configIds + ", caseIds=" + caseIds + "]";
	}
}