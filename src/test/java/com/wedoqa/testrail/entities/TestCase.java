...
public class TestCase extends BaseEntity {
    ...
    public String getCustomExpected() { return customExpected; }
    public void setCustomExpected(String customExpected) { this.customExpected = customExpected; }
    ...
    @JsonProperty("custom_caseid")
    private String customCaseId;
    public String getCustomCaseId() { return customCaseId; }
    public void setCustomCaseId(String customCaseId) { this.customCaseId = customCaseId; }
