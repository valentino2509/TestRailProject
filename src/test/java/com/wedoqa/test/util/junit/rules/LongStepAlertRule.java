    ...
    static {
        if (TestBaseStaticConfig.isCheckForLongSteps()) {
            try {
                ...
                client = new APIClient("https://wedoqa.testrail.net");	//FIXME Add TestRail link
                client.setUser("email");	//FIXME Add TestRail user name/email
                client.setPassword("pass");	//FIXME Add TestRail password
