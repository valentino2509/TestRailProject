...
import com.wedoqa.test.util.TestMode;
...
import com.wedoqa.testrail.enums.TestRailProjects;
...
public class TestBaseStaticConfig {
        ...
        switch (testMode) {
            case "QA":
                ...
                if (System.getProperty("user.home").contains("systemprofile")){
                    System.setProperty("user.home", "C:\\Users\\dms");	//FIXME add your download path
                }
                break;
            case "LOCAL":
            ...
            case "GRID":
                ...
                if (localDownloadFolderPathString == null || localDownloadFolderPathString.isEmpty()) {
                    logger.trace("No local download folder path found, use C:\\\\tr");	//FIXME add your own download path
                    localDownloadFolderPath = "C:\\\\tr";	//FIXME add your own download path
                } else {
    ...
    private static String getServerProperty(String serverProperty) {
        if(serverProperty == null || serverProperty.isEmpty()){
            logger.info("Server was null. Setting " + ServerURL.QA_URL + " as server.");
            return ServerURL.QA_URL;
        }
    ...
    private static TestRailProjects getTestRailProjectProperty(String testRailProject) {
        if(testRailProject == null || testRailProject.isEmpty()){
        	logger.info("TestRail Project was null. Setting TestRail Project to \"WeDoQa - Web\"");	//FIXME Change to your TestRail project name
        	return TestRailProjects.SC;
        }
